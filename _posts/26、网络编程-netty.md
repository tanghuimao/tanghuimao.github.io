...
![](../img/network/0021.png)

写模式下，position 是写入位置，limit 等于容量，下图表示写入了 4 个字节后的状态

![](../img/network/0018.png)

flip 动作发生后，position 切换为读取位置，limit 切换为读取限制

![](../img/network/0019.png)

读取 4 个字节后，状态

![](../img/network/0020.png)
...
```java
Bytebuffer buf = ByteBuffer.allocate(16); //java 堆内存  gc
ByteBuffer buf = ByteBuffer.allocateDirect(10); // 使用直接内存  回收由操作系统管理
```
...
![](../img/network/0033.png)

* 阻塞 IO

  ![](../img/network/0039.png)

* 非阻塞  IO

  ![](../img/network/0035.png)

* 多路复用

  ![](../img/network/0038.png)

* 信号驱动

* 异步 IO

  ![](../img/network/0037.png)

* 阻塞 IO vs 多路复用

  ![](../img/network/0034.png)

  ![](../img/network/0036.png)
...
>
>   ![](../img/network/0049.png)
>
> 
>
> * 为了解决此问题，引入了窗口概念，窗口大小即决定了无需等待应答而可以继续发送的数据最大值
>
>   ![](../img/network/0051.png)
>
...
>
>   <img src="../img/network/0031.jpg" style="zoom:50%;" />
